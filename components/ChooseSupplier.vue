    ...
    <div border-gray-300 shadow-xl border p-2 rounded-xl class="h-95%">
      ...
      <ul id="comboscroll" space-y-2 overflow-y-auto rounded-lg p-1 static mt-2>
        <li v-for="supplier in filteredSuppliers" :key="supplier.id">
          <div @click="selectedSupplier = supplier" font-semibold p-2 shadow border rounded border-gray-300 text-gray-700 cursor-pointer duration-150 hover="bg-gray-200">
            {{ supplier.name }}
          </div>
        </li>
      </ul>
